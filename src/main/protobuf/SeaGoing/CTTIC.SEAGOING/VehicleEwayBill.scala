...
final case class VehicleEwayBill(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): SeaGoing.CTTIC.SEAGOING.VehicleEwayBill = {
      ...
      SeaGoing.CTTIC.SEAGOING.VehicleEwayBill(
    ...
    def companion = SeaGoing.CTTIC.SEAGOING.VehicleEwayBill
}

object VehicleEwayBill extends com.trueaccord.scalapb.GeneratedMessageCompanion[SeaGoing.CTTIC.SEAGOING.VehicleEwayBill] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[SeaGoing.CTTIC.SEAGOING.VehicleEwayBill] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): SeaGoing.CTTIC.SEAGOING.VehicleEwayBill = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[SeaGoing.CTTIC.SEAGOING.VehicleEwayBill] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = CTTICSEAGOINGProto.javaDescriptor.getMessageTypes.get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = CTTICSEAGOINGProto.scalaDescriptor.messages(4)
  def messageCompanionForFieldNumber(__fieldNumber: Int): _root_.com.trueaccord.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__fieldNumber)
  def enumCompanionForFieldNumber(__fieldNumber: Int): _root_.com.trueaccord.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = SeaGoing.CTTIC.SEAGOING.VehicleEwayBill(
    vehicleNo = ""
  )
  implicit class VehicleEwayBillLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, SeaGoing.CTTIC.SEAGOING.VehicleEwayBill]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, SeaGoing.CTTIC.SEAGOING.VehicleEwayBill](_l) {
