...
final case class ProviderInfo(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): SeaGoing.CTTIC.SEAGOING.ProviderInfo = {
      ...
      SeaGoing.CTTIC.SEAGOING.ProviderInfo(
    ...
    def companion = SeaGoing.CTTIC.SEAGOING.ProviderInfo
}

object ProviderInfo extends com.trueaccord.scalapb.GeneratedMessageCompanion[SeaGoing.CTTIC.SEAGOING.ProviderInfo] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[SeaGoing.CTTIC.SEAGOING.ProviderInfo] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): SeaGoing.CTTIC.SEAGOING.ProviderInfo = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[SeaGoing.CTTIC.SEAGOING.ProviderInfo] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = CTTICSEAGOINGProto.javaDescriptor.getMessageTypes.get(6)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = CTTICSEAGOINGProto.scalaDescriptor.messages(6)
  def messageCompanionForFieldNumber(__fieldNumber: Int): _root_.com.trueaccord.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__fieldNumber)
  def enumCompanionForFieldNumber(__fieldNumber: Int): _root_.com.trueaccord.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = SeaGoing.CTTIC.SEAGOING.ProviderInfo(
    providerId = ""
  )
  implicit class ProviderInfoLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, SeaGoing.CTTIC.SEAGOING.ProviderInfo]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, SeaGoing.CTTIC.SEAGOING.ProviderInfo](_l) {
