...
final case class VehiclePosition(
    ...
    gnss: ctitc.seagoing.SEAGOING.Gnss,
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ctitc.seagoing.SEAGOING.VehiclePosition = {
      ...
      ctitc.seagoing.SEAGOING.VehiclePosition(
    ...
    def withGnss(__v: ctitc.seagoing.SEAGOING.Gnss): VehiclePosition = copy(gnss = __v)
    ...
    def companion = ctitc.seagoing.SEAGOING.VehiclePosition
}

object VehiclePosition extends com.trueaccord.scalapb.GeneratedMessageCompanion[ctitc.seagoing.SEAGOING.VehiclePosition] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[ctitc.seagoing.SEAGOING.VehiclePosition] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): ctitc.seagoing.SEAGOING.VehiclePosition = {
    ...
    ctitc.seagoing.SEAGOING.VehiclePosition(
      ...
      __fieldsMap(__fields.get(7)).asInstanceOf[ctitc.seagoing.SEAGOING.Gnss],
      __fieldsMap.get(__fields.get(8)).asInstanceOf[scala.Option[String]]
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[ctitc.seagoing.SEAGOING.VehiclePosition] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      ctitc.seagoing.SEAGOING.VehiclePosition(
        ...
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(8).get).get.as[ctitc.seagoing.SEAGOING.Gnss],
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(9).get).flatMap(_.as[scala.Option[String]])
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = SEAGOINGProto.javaDescriptor.getMessageTypes.get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = SEAGOINGProto.scalaDescriptor.messages(1)
  def messageCompanionForFieldNumber(__fieldNumber: Int): _root_.com.trueaccord.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.com.trueaccord.scalapb.GeneratedMessageCompanion[_] = null
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 8 => __out = ctitc.seagoing.SEAGOING.Gnss
    }
    __out
  }
  def enumCompanionForFieldNumber(__fieldNumber: Int): _root_.com.trueaccord.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = ctitc.seagoing.SEAGOING.VehiclePosition(
    accessCode = 0,
    city = 0,
    updateTime = 0L,
    vehicleNo = "",
    gnss = ctitc.seagoing.SEAGOING.Gnss.defaultInstance
  )
  implicit class VehiclePositionLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, ctitc.seagoing.SEAGOING.VehiclePosition]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, ctitc.seagoing.SEAGOING.VehiclePosition](_l) {
    ...
    def gnss: _root_.com.trueaccord.lenses.Lens[UpperPB, ctitc.seagoing.SEAGOING.Gnss] = field(_.gnss)((c_, f_) => c_.copy(gnss = f_))
